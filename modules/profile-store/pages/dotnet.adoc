...
* *High Scalability*: Couchbase makes it link:https://docs.couchbase.com/server/6.0/learn/services-and-indexes/services/services.html[easy to scale] horizontally, and it makes it easy to scale individual services vertically with multi-dimensional scaling (MDS)
